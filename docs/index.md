...
##Results
Standard deviation provided interesting results with the requests column, larger numbers. Results were limited with the error column which had lower numbers, returns were 1-2. I also noticed that in rounding, the standard deviation calculations may be off. For example, 8 errors with a rolling mean of 5, standard deviation 2. Mathmatically appears incorrect.
